...
import 'package:evently/core/widgets/ui_utils/ui_utils.dart';
  ...
  void createAccount() async {
    ...
    try {
     ...
     await FirebaseService.addUserToFireStore(user);
      ...
      UIUtils.toastMessage(appLocalizations.successfully_registered, Colors.green);
      Navigator.pushReplacementNamed(context, RoutesManager.login);
    } on FirebaseAuthException catch (e) {
       if (e.code == 'email-already-in-use') {
         UIUtils.hideDialog(context);
         UIUtils.toastMessage(appLocalizations.the_account_already_exists_for_that_email, ColorsManager.red);
      }
    } catch (e) {
      UIUtils.hideDialog(context);
      UIUtils.toastMessage(appLocalizations.failed_to_register, ColorsManager.red);
    }
  }
}
